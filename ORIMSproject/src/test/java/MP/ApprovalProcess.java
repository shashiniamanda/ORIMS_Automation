...
public class ApprovalProcess extends BaseTest {
    ...
    public void RecommendationApproval() {
        ...
        try {
            ...
            WebElement MpTile = driver.findElement(
                    By.xpath(loc.getProperty("recommendation-mp")));
            MpTile.click();

            Thread.sleep(2000);

            WebElement row = driver.findElement(By.xpath(
                    loc.getProperty("recommendation-mp-firstRow")));
            row.click();
    ...
    public void ApprovalStageApproval() {
        ...
        try {
            ...
            WebElement MpTile = driver.findElement(
                    By.xpath(loc.getProperty("approval-mp")));
            MpTile.click();

            Thread.sleep(2000);

            WebElement row = driver.findElement(By.xpath(
                    loc.getProperty("approval-mp-firstRow")));
            row.click();
    ...
    public void CertificationApproval() {
        ...
        try {
            ...
            WebElement MpTile = driver.findElement(
                    By.xpath(loc.getProperty("certification-mp")));
            MpTile.click();

            Thread.sleep(2000);

            WebElement row = driver.findElement(By.xpath(
                    loc.getProperty("certification-mp-firstRow")));
            row.click();
    ...
    public void ChequeApproval(String voucherNumber, String chequeNumber, String chequeIssuedDate) {
        ...
        try {
            ...
            WebElement MpTile = driver.findElement(
                    By.xpath(loc.getProperty("cheque-payment-mp")));
            MpTile.click();

            Thread.sleep(2000);

            WebElement row = driver.findElement(By.xpath(
                    loc.getProperty("cheque-payment-mp-firstRow")));
            row.click();
        ...
        public void ChequePrint (String language, String paymentDate, String paymentReference, String officer){
            ...
            try {
               ...
               previousMenu.click();
                ...
                WebElement MpTile = driver.findElement(
                        By.xpath(loc.getProperty("cheque-print-mp")));
                MpTile.click();
